...
namespace DataCreator.Shared
{
  ...
  public class DataCollector
  {
    ...
    private StringBuilder GenerateInstabilities(int scale)
    {
      ...
      foreach (var instability in Constants.Instabilities[scale - 1])
        builder.Append(Gw2Helper.GenerateHelpIcon(instability.Image, instability.Name + ": " + instability.Description));
      return builder;
    }
